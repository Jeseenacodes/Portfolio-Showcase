      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-foreground/80 mb-8 leading-relaxed">Compassionate Quran instruction for children and women by a Hafidha and Alimiyya graduate with nearly a decade of teaching experience.</p>
